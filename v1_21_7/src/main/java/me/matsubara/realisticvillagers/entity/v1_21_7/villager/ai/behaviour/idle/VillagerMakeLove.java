package me.matsubara.realisticvillagers.entity.v1_21_7.villager.ai.behaviour.idle;
...
public class VillagerMakeLove extends Behavior<Villager> {
    ...
    private Optional<Villager> breed(ServerLevel level, Villager villager, Villager breedWith) {
        ...
        baby.loadPluginData(net.minecraft.world.level.storage.TagValueInput.create(net.minecraft.util.ProblemReporter.DISCARDING, baby.level().registryAccess(), new CompoundTag()));
