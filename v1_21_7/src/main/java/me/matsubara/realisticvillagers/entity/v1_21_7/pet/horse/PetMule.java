package me.matsubara.realisticvillagers.entity.v1_21_7.pet.horse;
...
public class PetMule extends Mule implements Pet, HorseEating {
    ...
    public PetMule(EntityType<? extends Mule> type, Level level) {
        super(type, level);
    }
