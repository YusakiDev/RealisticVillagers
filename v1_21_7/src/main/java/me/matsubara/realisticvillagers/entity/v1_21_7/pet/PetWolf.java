package me.matsubara.realisticvillagers.entity.v1_21_7.pet;
...
public class PetWolf extends Wolf implements Pet {
    ...
    protected void registerGoals() {
        ...
        targetSelector.addGoal(4, new NearestAttackableTargetGoal<Player>(this, Player.class, 10, true, false, (living, level) -> this.isAngry()));
        targetSelector.addGoal(4, new NearestAttackableTargetGoal<VillagerNPC>(this, VillagerNPC.class, 10, true, false, (living, level) -> this.isAngry()));
    ...
    public void tameByVillager(@NotNull IVillagerNPC npc) {
        setTame(true, true);
        setOwner((net.minecraft.world.entity.LivingEntity) ((org.bukkit.craftbukkit.v1_21_R5.entity.CraftLivingEntity) npc.bukkit()).getHandle());
    ...
    public UUID getOwnerUniqueId() {
        return getOwnerReference() != null ? getOwnerReference().getUUID() : null;
    }

    @Override
    protected void addAdditionalSaveData(ValueOutput output) {
        super.addAdditionalSaveData(output);
        output.putBoolean(plugin.getTamedByVillagerKey().toString(), tamedByVillager);
    }

    @Override
    public void readAdditionalSaveData(ValueInput input) {
        super.readAdditionalSaveData(input);
        tamedByVillager = input.getBooleanOr(plugin.getTamedByVillagerKey().toString(), false);
    }
