...
public class CustomGossipContainer extends GossipContainer {
    ...
    public void remove(GossipType type) {
        remove(type, ReputationEvent.UNSPECIFIED);
    }
