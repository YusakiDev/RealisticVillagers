...
package me.matsubara.realisticvillagers.util.customblockdata.events;
...
public class CustomBlockDataRemoveEvent extends CustomBlockDataEvent {
    ...
    public CustomBlockDataRemoveEvent(@NotNull Plugin plugin, @NotNull Block block, @NotNull Event bukkitEvent) {
